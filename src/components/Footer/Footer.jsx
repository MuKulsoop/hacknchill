    ...
    <footer className='bg-gray-900 text-white'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 '>
          ...
          >
            ...
            <ul className='flex flex-col items-start mx-5 text-sm'>
              <li><Link to='/sign-up' className='text-white text-sm'>How it works</Link></li>
          ...
          <div>
            ...
            <ul className='flex flex-col items-start text-sm'>
              ...
              <li><Link to='/report-bug' className='text-white'>Report a Bug</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className='flex flex-col items-start text-sm'>
              <li><Link to='/suggest-games' className='text-white'>Suggest Games</Link></li>
              <li><Link to='/games/minecraft' className='text-white'>Minecraft</Link></li>
              <li><Link to='/games/play-together' className='text-white'>Play Together</Link></li>
              <li><Link to='/games/influencer' className='text-white'>Influencer</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className='flex flex-col items-start text-sm'>
              ...
              <li><a href='https://youtube.com' className='text-white' target='_blank' rel='noopener noreferrer'>Youtube</a></li>
      ...
      <div className='bg-gray-800 py-4'>
        <div className='container mx-auto flex justify-between items-center'>
          <Link to='/home' className='text-xl font-bold text-white flex flex-row items-center'>
            {/* <img src="/images/logo.png" alt="" className='h-5 w-5 mx-2'/> */}
            ThreadHive</Link>
          <p className='text-gray-400'>&copy; {new Date().getFullYear()} ThreadHive</p>
          <div className='social-icons'>
            ...
            <a href='https://youtube.com' className='social-icon-link' aria-label='Youtube' target='_blank' rel='noopener noreferrer'>
              <ion-icon name="logo-youtube" ></ion-icon>
            </a>
            <a href='https://linkedin.com' className='social-icon-link' aria-label='LinkedIn' target='_blank' rel='noopener noreferrer'>
